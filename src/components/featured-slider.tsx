    ...
    <div className="relative w-full px-2 md:px-6">
      ...
      {products.length > 1 && (
        <>
          <button
            onClick={prevSlide}
            className="absolute -left-2 md:-left-4 top-1/2 -translate-y-1/2 flex h-9 w-9 items-center justify-center rounded-full bg-black/60 border border-brand-green/30 text-brand-green hover:text-white hover:bg-brand-green/20 hover:scale-110 active:scale-95 transition-all z-20 shadow-md shadow-brand-green/10 cursor-pointer"
          ...
          <button
            onClick={nextSlide}
            className="absolute -right-2 md:-right-4 top-1/2 -translate-y-1/2 flex h-9 w-9 items-center justify-center rounded-full bg-black/60 border border-brand-green/30 text-brand-green hover:text-white hover:bg-brand-green/20 hover:scale-110 active:scale-95 transition-all z-20 shadow-md shadow-brand-green/10 cursor-pointer"
